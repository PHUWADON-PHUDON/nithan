...
export default function Editor({content,setcontent,setinputfile,setisload = () => null}:ContentType) {
    ...
    return(
        <div className='mt-[10px] grow flex flex-col overflow-hidden'>
            ...
            <div className="grow  overflow-scroll mt-[10px]">
                <EditorContent className='p-[20px] mt-[10px]' editor={editor} />
            </div>
        </div>
    );
}