    ...
    return(
        <div style={darkmodeprovider_.isdark ? {backgroundColor:"#000",color:"#fff"}:{backgroundColor:"#fff",color:"#000"}} className="w-full h-full p-[0_20px]">
            <div className="absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] shadow-[0_0_8px_#949494] flex flex-col p-[30px] rounded-[20px] items-center">
                ...
                <input style={darkmodeprovider_.isdark ? {backgroundColor:"#2e2e2e"}:{backgroundColor:"#0000000d"}} className="h-[35px] w-[250px] rounded-[20px] focus:outline-none pl-[10px] mt-[20px]" type="text" onChange={(e) => setinputusername(e.target.value)} placeholder="Username" />
                {checkinput.username ? <p className="text-[#ff0033] text-[12px] self-baseline ml-[10px]">input username!</p>:""}
                <input style={darkmodeprovider_.isdark ? {backgroundColor:"#2e2e2e"}:{backgroundColor:"#0000000d"}} className="h-[35px] w-[250px] rounded-[20px] focus:outline-none pl-[10px] mt-[20px]" type="text" onChange={(e) => setinputgmail(e.target.value)} placeholder="Gmail" />
                ...
                <input style={darkmodeprovider_.isdark ? {backgroundColor:"#2e2e2e"}:{backgroundColor:"#0000000d"}} className="h-[35px] w-[250px] rounded-[20px] focus:outline-none pl-[10px] mt-[20px]" type="password" onChange={(e) => setinputconfirmpassword(e.target.value)} placeholder="Confirm Password" />
